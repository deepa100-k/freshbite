...
import protein from "../assets/CreamySpinachSoupcard-10.avif"; // Protein naam se sahi import hua
...
const categories = [
  ...
  { id: 6, name: "Soups", image: protein }, // Yahan 'protein' variable use kiya aur name 'Soups' kiya taaki Menu se match ho
];
